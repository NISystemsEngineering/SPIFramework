...
<Library LVVersion="14008000">
	...
	<Item Name="Scripting" Type="Folder">
		<Item Name="Initialization" Type="Folder">
			...
			<Item Name="Check CS Lines vs Devices.vi" Type="VI" URL="../Initialization/Check CS Lines vs Devices.vi"/>
		...
		<Item Name="IO Nodes" Type="Folder">
			<Item Name="Sub VIs" Type="Folder">
				<Item Name="Create FPGA Data Node.vi" Type="VI" URL="../IO Nodes/Sub VIs/Create FPGA Data Node.vi"/>
				<Item Name="Place IO Node in Block Diagram.vi" Type="VI" URL="../IO Nodes/Sub VIs/Place IO Node in Block Diagram.vi"/>
			</Item>
			<Item Name="Create FPGA Data Node - Top.vi" Type="VI" URL="../IO Nodes/Create FPGA Data Node - Top.vi"/>
			<Item Name="IO Nodes Close References.vi" Type="VI" URL="../IO Nodes/Sub VIs/IO Nodes Close References.vi"/>
			<Item Name="New IO Node.vi" Type="VI" URL="../IO Nodes/New IO Node.vi"/>
		</Item>
		<Item Name="Project FIFOs" Type="Folder">
			...
			<Item Name="Create Project FIFOs - Top.vi" Type="VI" URL="../Project FIFOs/Create Project FIFOs - Top.vi"/>
			<Item Name="Create RX and TX FIFOs.vi" Type="VI" URL="../Project FIFOs/Create RX and TX FIFOs.vi"/>
		</Item>
		<Item Name="Project Structure" Type="Folder">
			...
			<Item Name="Create Virtual Folder (Target In).vi" Type="VI" URL="../Project Structure/Create Virtual Folder (Target In).vi"/>
			<Item Name="Create Virtual Folder Hierarchy.vi" Type="VI" URL="../Project Structure/Create Virtual Folder Hierarchy.vi"/>
		</Item>
		<Item Name="SPI Engine" Type="Folder">
			...
			<Item Name="Place VI on Block Diagram.vi" Type="VI" URL="../Supporting VIs/Place VI on Block Diagram.vi"/>
		</Item>
	</Item>
	<Item Name="State Machine" Type="Folder">
		...
		<Item Name="Sub VIs" Type="Folder">
			<Item Name="Initialization" Type="Folder">
				<Item Name="Check for Valid File Paths.vi" Type="VI" URL="../State Machine/Sub VIs/Check for Valid File Paths.vi"/>
			</Item>
			<Item Name="Iterative Operations" Type="Folder"/>
			...
			<Item Name="Iterative Operations.vi" Type="VI" URL="../State Machine/Sub VIs/Iterative Operations.vi"/>
		</Item>
	</Item>
	<Item Name="Supporting VIs" Type="Folder">
	...
	<Item Name="Check if Buses Defined.vi" Type="VI" URL="../Initialization/Check if Buses Defined.vi"/>
	<Item Name="Create Virtual Folder (Project Item In).vi" Type="VI" URL="../Project Structure/Create Virtual Folder (Project Item In).vi"/>
	<Item Name="Error Handler and Log.vi" Type="VI" URL="../State Machine/Sub VIs/Error Handler and Log.vi"/>
	<Item Name="Rename Engine to Match Bus.vi" Type="VI" URL="../Initialization/Rename Engine to Match Bus.vi"/>
	<Item Name="Set Device and Channel IDs in IO Node.vi" Type="VI" URL="../IO Nodes/Sub VIs/Supporting VIs/Set Device and Channel IDs in IO Node.vi"/>
	<Item Name="Set FIFO Names in IO Node.vi" Type="VI" URL="../IO Nodes/Sub VIs/Supporting VIs/Set FIFO Names in IO Node.vi"/>
